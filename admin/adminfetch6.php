...
while($row = mysqli_fetch_array($query))
{
 ...
 //$sub_data[] =  '<button  class="btn btn-info delete btn-xm">check</button>'; //newly added
 /*$sub_data[] =  $row[7];
 $sub_data[] =  $row[8];
 $sub_data[] =  $row[9];
 $sub_data[] =  $row[10];*/
// $sub_data[] =  '<a href="RelativeInfo.php?id='.$row[0].'" onclick="return confirm(\'are you sure?\' )"  class="btn btn-info delete btn-xm">Verify</a>';
