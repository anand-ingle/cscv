 ...
 -->               
   ...
   <!---------------------------------------------------------------------------------------------------------------------------------------->          
     ...
     <!---------------------------------------------------------------------------------------------------------------------------------------->          
            ...
            <div class="check container"><div class="row col-md-12">
                <div class="form-group">
                  <label>Is The Information Correct ?</label>    
                  <input type="button" class=" btn btn-info col-md-4" value="OK" name="okv1" id="okv1">
                  <input type="button" class=" btn btn-danger col-md-4" value="Not Ok" name="okv2" id="okv2"> 
                  <input type="text" class="form-control col-md-12" name="comment" value="comment">
              </div>
              <div class="row col-md-12">
                <input type="submit" class="btn  btn-danger btn-raised" name="submit1" id="sumbit1" value="Submit">
                <input type="submit" class="btn  btn-danger btn-raised" name="modification1" id="Modification1" value="Submit">
              <div>
                  </div>   
